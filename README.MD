...
|----|----|
|HTTP 请求方式|GET|
|URL|https://api.anycen.com/instrument/?type=uppocess|
...
|key|String|是|authkey与时间戳计算值|
|name|String|是|监控软件名|
|pocess|String|是|监控进程名|
|potype|String|是|监控进程类型（EXE、DLL等）|
